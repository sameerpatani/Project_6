        ...
        <tr>
            <td align="center">
                <asp:Button ID="Button12" runat="server" CssClass="btn" Text="VIEW ACCOUNT" 
                    onclick="Button12_Click" style="background:lightsteelblue" ForeColor="Black"/>
&nbsp;<asp:Button ID="Button13" runat="server" CssClass="btn" Text="EDIT ACCOUNT" 
                    onclick="Button13_Click" style="background:lightsteelblue" ForeColor="Black"/>
            &nbsp;<asp:Button ID="Button14" runat="server" CssClass="btn" Text="CHANGE PASSWORD" 
                    onclick="Button14_Click" style="background:lightsteelblue" ForeColor="Black"/>
            </td>
        </tr>
        <tr>
            <td align="center">
                        ...
                        <table align="center" class="style1" style="border: thin solid #009900">
                            ...
                            <tr>
                                <td class="style2">
                                    &nbsp;</td>
                                <td align="left">
                                    <asp:Button ID="btnupdate" runat="server" CssClass="btn" style="background:lightsteelblue" ForeColor="Black" 
                        ...
                        <table style="border: thin solid #009900">
                            ...
                            <tr>
                                <td>
                                    &nbsp;</td>
                                <td align="left">
                                    <asp:Button ID="Button15" runat="server" CssClass="btn" style="background:lightsteelblue" ForeColor="Black"
